...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.toolButton_exportAsSource = QtWidgets.QToolButton(self.groupBox_3)
        self.toolButton_exportAsSource.setText("")
        self.toolButton_exportAsSource.setIconSize(QtCore.QSize(32, 32))
        self.toolButton_exportAsSource.setObjectName("toolButton_exportAsSource")
        self.horizontalLayout.addWidget(self.toolButton_exportAsSource)
        self.toolButton_exportAsOutput = QtWidgets.QToolButton(self.groupBox_3)
        self.toolButton_exportAsOutput.setText("")
        self.toolButton_exportAsOutput.setIconSize(QtCore.QSize(32, 32))
        self.toolButton_exportAsOutput.setObjectName("toolButton_exportAsOutput")
        self.horizontalLayout.addWidget(self.toolButton_exportAsOutput)
        ...
        self.actionExportAsSource = QtWidgets.QAction(MainWindow)
        self.actionExportAsSource.setObjectName("actionExportAsSource")
        self.actionExportAsOutput = QtWidgets.QAction(MainWindow)
        self.actionExportAsOutput.setObjectName("actionExportAsOutput")
        self.menuExport_As.addAction(self.actionExportAsSource)
        self.menuExport_As.addAction(self.actionExportAsOutput)
        ...
        self.toolBar_2.addSeparator()
        self.toolBar_2.addAction(self.actionExportAsSource)
        self.toolBar_2.addAction(self.actionExportAsOutput)
        self.toolBar_2.addSeparator()
        ...
        self.toolButton_exportAsOutput.clicked.connect(self.actionExportAsOutput.trigger)
        self.toolButton_exportAsSource.clicked.connect(self.actionExportAsSource.trigger)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolButton_exportAsSource.setToolTip(_translate("MainWindow", "Export As Source"))
        self.toolButton_exportAsSource.setStatusTip(_translate("MainWindow", "Export as source"))
        self.toolButton_exportAsOutput.setToolTip(_translate("MainWindow", "Export As Output"))
        self.toolButton_exportAsOutput.setStatusTip(_translate("MainWindow", "Export as output"))
        ...
        self.menuExport_As.setToolTip(_translate("MainWindow", "Export As"))
        self.menuExport_As.setStatusTip(_translate("MainWindow", "Export As"))
        self.menuExport_As.setTitle(_translate("MainWindow", "Export As"))
        self.menuEdit.setTitle(_translate("MainWindow", "Edit"))
        self.menuClear.setToolTip(_translate("MainWindow", "Clear"))
        ...
        self.actionClearSource.setToolTip(_translate("MainWindow", "Clear Source"))
        self.actionClearSource.setStatusTip(_translate("MainWindow", "Clear source"))
        self.actionClearOutput.setText(_translate("MainWindow", "Output"))
        self.actionClearOutput.setToolTip(_translate("MainWindow", "Clear Output"))
        self.actionClearOutput.setStatusTip(_translate("MainWindow", "Clear output"))
        ...
        self.actionExportAsSource.setText(_translate("MainWindow", "Source"))
        self.actionExportAsSource.setToolTip(_translate("MainWindow", "Export As Source"))
        self.actionExportAsSource.setStatusTip(_translate("MainWindow", "Export as source"))
        self.actionExportAsOutput.setText(_translate("MainWindow", "Output"))
        self.actionExportAsOutput.setToolTip(_translate("MainWindow", "Export As Output"))
        self.actionExportAsOutput.setStatusTip(_translate("MainWindow", "Export as output"))
